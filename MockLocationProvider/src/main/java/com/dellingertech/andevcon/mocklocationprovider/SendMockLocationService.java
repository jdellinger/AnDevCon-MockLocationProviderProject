...
package com.dellingertech.andevcon.mocklocationprovider;
...
//                LocationUtils.WAYPOINTS_LNG, LocationUtils.WAYPOINTS_ACCURACY);
    ...
    private TestLocation[] buildTestLocationArray(String filename, float accuracy){
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                locations.add(new TestLocation(Integer.toString(locations.size()),
            ...
            Log.e("MockLocationService", "Exception loading test data", ex);
        }
        Log.d("MockLocationService", "Returning "+ locations.size()+" locations");
